...
export default {
	...
	'faq.whyUpgrade.answer': 'By default, you are using our open-source Community edition. While the Community edition has no limits on active workflows, you won’t have access to any of the premium n8n features. This includes workflows & credentials sharing, LDAP, advanced logging, multi-environments (coming soon), and much more.',
